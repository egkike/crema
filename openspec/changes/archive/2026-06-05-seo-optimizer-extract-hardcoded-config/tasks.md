...
| 3 | Document new env keys | `backend/.env.example` | +4 | [x] |
| 4 | Full verification + grep checks | (gates only) | n/a | [x] |
| 5 | Update project documentation | `docs/project/reusable-resources.md` + `docs/project/ai-features/PRD.md` | +6 | [x] |
